  ...
  return (
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div
          className="min-h-[70vh] rounded-lg overflow-hidden bg-slate-800 border border-slate-700
            ...
            [&_.rbc-today]:bg-orange-100
            [&_.rbc-event]:bg-orange-600 [&_.rbc-event]:text-white [&_.rbc-event]:border-orange-500"
        >
          <Calendar
            localizer={localizer}
            events={sampleEvents}
