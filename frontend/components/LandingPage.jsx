...
function FeatureCard({ icon: Icon, title, items }) {
  return (
    <div className="rounded-2xl border border-zinc-700 bg-zinc-900/40 p-6 transition-colors hover:border-zinc-600">
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-800 text-zinc-100 text-[15px]">
      <header className="sticky top-0 z-50 border-b border-zinc-700 bg-zinc-900/95 backdrop-blur-sm">
      ...
      <main>
        {/* 1. Hero: purpose & CTAs */}
        <section className="border-b border-zinc-700/80 bg-linear-to-b from-zinc-900/40 to-zinc-800 px-4 py-20 sm:py-28">
        ...
        <section
          id="how-it-works"
          className="scroll-mt-28 border-b border-zinc-700/80 px-4 py-20 sm:py-24"
        >
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-12 grid gap-12 lg:grid-cols-2">
              <div className="rounded-2xl border border-zinc-700 bg-zinc-900/50 p-6 sm:p-8">
                <div className="flex items-center gap-3 border-b border-zinc-700 pb-4">
                  <div
                    className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#7C1D2E]/20"
                  >
                    <BookOpen className="h-5 w-5 text-[#FE9F2B]" aria-hidden />
                  </div>
                  <h3 className="text-lg font-semibold text-white">Instructor flow</h3>
                </div>
                <ol className="mt-6 space-y-4 text-zinc-300">
                  <li className="flex gap-3">
                    ...
                    <span>
                      <strong className="text-white">Create an assignment</strong> with a title,
                  ...
                  <li className="flex gap-3">
                    ...
                    <span>
                      Define the problem: <strong className="text-white">what to build</strong>,{" "}
                      <strong className="text-white">constraints</strong>, and how{" "}
                      <strong className="text-white">input and output</strong> should look.
                    </span>
                  </li>
                  <li className="flex gap-3">
                    <span
                    ...
                    <span>
                      Add <strong className="text-white">test cases</strong>: mark some as visible to
                  ...
                  <li className="flex gap-3">
                    ...
                    <span>
                      Set <strong className="text-white">rubrics and scoring</strong>, then{" "}
                      <strong className="text-white">publish</strong> when the class is ready.
                    </span>
                  </li>
                </ol>
              </div>
              ...
              <div className="rounded-2xl border border-zinc-700 bg-zinc-900/50 p-6 sm:p-8">
                <div className="flex items-center gap-3 border-b border-zinc-700 pb-4">
                  ...
                  <h3 className="text-lg font-semibold text-white">Student flow</h3>
                </div>
                <ol className="mt-6 space-y-4 text-zinc-300">
                  <li className="flex gap-3">
                    <span
                    ...
                    <span>
                      Open the course assignment and read the <strong className="text-white">problem</strong>{" "}
                  ...
                  <li className="flex gap-3">
                    ...
                    <span>
                      <strong className="text-white">Write or upload</strong> your source code in the
                      supported language.
                    </span>
                  </li>
                  <li className="flex gap-3">
                    ...
                    <span>
                      <strong className="text-white">Submit</strong>, and the system compiles and runs your
                  ...
                  <li className="flex gap-3">
                    ...
                    <span>
                      Get a <strong className="text-white">verdict</strong> (pass/fail per test),{" "}
                      <strong className="text-white">score</strong> when released, and feedback such as
        ...
        {/* 3. Features */}
        <section id="features" className="scroll-mt-28 border-b border-zinc-700/80 px-4 py-20 sm:py-24">
          <div className="mx-auto max-w-6xl">
            <h2 className="text-center text-2xl font-bold text-white sm:text-3xl">What CodeHawk does</h2>
            <p className="mx-auto mt-3 max-w-2xl text-center text-zinc-400">
        ...
        <section id="demo" className="scroll-mt-28 border-b border-zinc-700/80 px-4 py-20 sm:py-24">
          <div className="mx-auto max-w-3xl">
            <h2 className="text-center text-2xl font-bold text-white sm:text-3xl">Sample problem</h2>
            ...
            <div className="mt-10 rounded-2xl border border-zinc-700 bg-zinc-900/60 p-7 sm:p-8">
              <h3 className="font-semibold text-white">Sum two numbers (example)</h3>
              <p className="mt-2 text-sm leading-relaxed text-zinc-400">
                Read two integers from standard input, print their sum on one line.
              </p>
              <div className="mt-4 flex flex-wrap gap-2 text-xs text-zinc-500">
                <span className="rounded-md bg-zinc-800 px-2 py-1 font-mono">Public sample</span>
                <span className="rounded-md bg-zinc-800 px-2 py-1 font-mono">Input: (a = 2, b = 3) → Output: 5</span>
              </div>

              <pre className="mt-4 overflow-x-auto rounded-xl border border-zinc-700 bg-zinc-950 p-4 text-left text-sm text-zinc-200 font-mono">
...
print(a + b)`}</code>
              ...
              {demoRan && (
                <div
                  className="mt-4 rounded-xl border border-zinc-600 bg-zinc-900 p-4 text-sm"
                  role="status"
                >
                  <p className="font-medium text-white">Simulated output</p>
        ...
        <section className="border-b border-zinc-700/80 px-4 py-20 sm:py-24">
          <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-2">
            <div className="rounded-2xl border border-zinc-700 bg-zinc-900/40 p-6 sm:p-8">
              ...
              <ul className="mt-5 space-y-3 text-zinc-400">
                ...
                <li className="flex gap-2">
                  <CheckCircle2 className="mt-0.5 h-5 w-5 shrink-0 text-emerald-500/90" aria-hidden />
                  Deadlines and late submission rules on assignments
                </li>
                <li className="flex gap-2">
                  <CheckCircle2 className="mt-0.5 h-5 w-5 shrink-0 text-emerald-500/90" aria-hidden />
            ...
            <div className="mt-10 flex flex-col gap-7">
              <div className="rounded-2xl border border-zinc-700 bg-zinc-900/40 p-6 sm:p-8">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xl font-bold text-white">Who it&apos;s for</h2>
                </div>
                <p className="mt-4 text-zinc-400">
              ...
              <div className="rounded-2xl border border-zinc-700 bg-zinc-900/40 p-6 sm:p-8">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xl font-bold text-white">What CodeHawk does</h2>
                </div>
                <p className="mt-4 text-zinc-400">
        ...
        <section className="border-b border-zinc-700/80 px-4 py-20 sm:py-24">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-2xl font-bold text-white sm:text-3xl">Get access</h2>
            <p className="mt-4 text-zinc-400">
              Create an account with your email. You&apos;ll choose <strong className="text-zinc-200">Student</strong> or{" "}
              <strong className="text-zinc-200">Faculty</strong> when you register. Institutional rollout
      ...
      {/* 14. Footer */}
      <footer className="border-t border-zinc-700 bg-zinc-900 px-4 py-12">
        <div className="mx-auto max-w-6xl">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-2 text-xs text-zinc-500">
              <span className="rounded-full border border-zinc-700 bg-zinc-800 px-3 py-1.5">
                Students
              </span>
              <span className="rounded-full border border-zinc-700 bg-zinc-800 px-3 py-1.5">
                TAs
          ...
          <div className="mt-8 border-t border-zinc-800 pt-6 text-center text-xs text-zinc-600 sm:text-left">
